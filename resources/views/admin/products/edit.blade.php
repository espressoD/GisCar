    ...
    <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="mb-2">
                    <label>Jenis</label>
                    <input type="text" name="jenis" class="form-control" value="{{ $product->jenis }}" required>
                </div>
                <div class="mb-2">
                    <label>Merk</label>
                ...
                <div class="mb-2">
                    <label>Daerah</label>
                    <input type="text" name="daerah" class="form-control" value="{{ $product->daerah }}" required>
                </div>
                <div class="mb-2">
                    <label>Kontak</label>
                    <input type="text" name="kontak" class="form-control" value="{{ $product->kontak }}" required>
                </div>
                <div class="mb-2">
                ...
                <div class="mb-2">
                    ...
                    <img src="{{ asset('storage/' . $product->gambar) }}" width="120">
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="mb-2">
                    <label>Alamat</label>
                    <input type="text" id="alamat" name="alamat" class="form-control" value="{{ $product->alamat }}" required>
                </div>
                <div class="mb-2">
                ...
                <input type="hidden" id="Lat" name="Lat" value="{{ old('Lat', $product->Lat ?? '') }}">
                <input type="hidden" id="Long" name="Long" value="{{ old('Long', $product->Long ?? '') }}">
