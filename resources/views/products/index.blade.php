        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              @else
                  <li><div class="main-white-button"><a href="{{ route('login') }}"></i>Login</a></div></li> 
              @endauth
              ...
              <div class="col-lg-3 align-self-center">
                <fieldset>
                  <select name="area" class="form-select" onchange="this.form.submit()">
                    <option value="" {{ request('area') == '' ? 'selected' : '' }}>All Areas</option>
                    @foreach($areas as $area)
                      <option value="{{ $area->daerah }}" {{ request('area') == $area->daerah ? 'selected' : '' }}>
                        {{ $area->daerah }}
                      </option>
                    @endforeach
                  </select>
              ...
              <div class="col-lg-3 align-self-center">
                <fieldset>
                  <select name="jenis" class="form-select" onchange="this.form.submit()">
                    <option value="" {{ request('jenis') == '' ? 'selected' : '' }}>All Car Types</option>
                    @foreach($carTypes as $type)
                      <option value="{{ $type->jenis }}" {{ request('jenis') == $type->jenis ? 'selected' : '' }}>
                        {{ $type->jenis }}
                      </option>
                    @endforeach
                  </select>
                ...
                <fieldset>
                  <select name="brand" class="form-select" onchange="this.form.submit()">
                    ...
                    @foreach($brands as $brand)
                      <option value="{{ $brand->merk }}" {{ request('brand') == $brand->merk ? 'selected' : '' }}>
                        {{ $brand->merk }}
                      </option>
                    @endforeach
                  </select>
              ...
              <div class="col-lg-3 align-self-center">
                <fieldset>
                  <select name="price" class="form-select" onchange="this.form.submit()">
                    <option value="" {{ request('price') == '' ? 'selected' : '' }}>All Price Ranges</option>
                    <option value="low" {{ request('price') == 'low' ? 'selected' : '' }}>Rp 100JT - Rp 250JT</option>
                    <option value="mid" {{ request('price') == 'mid' ? 'selected' : '' }}>Rp 250JT - Rp 500JT</option>
                    <option value="high" {{ request('price') == 'high' ? 'selected' : '' }}>Rp 500JT - Rp 1M</option>
                    <option value="luxury" {{ request('price') == 'luxury' ? 'selected' : '' }}>Rp 1M or more</option>
                  </select>
                </fieldset>
              </div>
            </div>
          ...
          <div class="col-md-12">
            <div id="map"></div>
                <script>
                  ...
                  const allData = @json($initialMarkers);
                  let markers = [];
